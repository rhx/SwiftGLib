...
![macOS](https://github.com/rhx/SwiftGLib/actions/workflows/macOS.yml/badge.svg?branch=main)
![Linux](https://github.com/rhx/SwiftGLib/actions/workflows/Linux.yml/badge.svg?branch=main)
![DocC](https://github.com/rhx/SwiftGLib/actions/workflows/docc.yml/badge.svg?branch=main)
...
These Swift wrappers have been tested with glib-2.56, 2.58, 2.60, 2.62, 2.64, 2.66, 2.68, 2.70, 2.72, 2.73, 2.74, 2.76, 2.78, 2.80, 2.82, 2.84, 2.86, 2.88, and 2.90.  They should work with higher versions, but YMMV.  Also make sure you have `gobject-introspection` and its `.gir` files installed.
