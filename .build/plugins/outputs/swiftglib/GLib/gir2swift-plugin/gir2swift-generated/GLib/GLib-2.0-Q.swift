...
public extension QueueProtocol {
    ...
    @inlinable func copy() -> QueueRef! {
        let result = g_queue_copy(_ptr)
        guard let rv = QueueRef(gconstpointer: gconstpointer(result)) else { return nil }
        return rv
    }
    ...
    @inlinable func find(data: gconstpointer? = nil) -> ListRef! {
        let result = g_queue_find(_ptr, data)
    ...
    @inlinable func findCustom(data: gconstpointer? = nil, `func`: GCompareFunc?) -> ListRef! {
        let result = g_queue_find_custom(_ptr, data, `func`)
        let rv = ListRef(gconstpointer: gconstpointer(result))
        return rv
    }
    ...
    @inlinable func getLength() -> Int {
        let result = g_queue_get_length(_ptr)
        let rv = Int(result)
        return rv
    }
    ...
    @inlinable func index(data: gconstpointer? = nil) -> Int {
        let result = g_queue_index(_ptr, data)
        let rv = Int(result)
        return rv
    }
    ...
    @inlinable func linkIndex<ListT: ListProtocol>(link: ListT) -> Int {
        let result = g_queue_link_index(_ptr, link._ptr)
        let rv = Int(result)
        return rv
    }
    ...
    @inlinable func peekHead() -> gpointer? {
        let result = g_queue_peek_head(_ptr)
        let rv = result
        return rv
    }

    /// Returns the first link in `queue`.
    @inlinable func peekHeadLink() -> ListRef! {
        let result = g_queue_peek_head_link(_ptr)
        let rv = ListRef(gconstpointer: gconstpointer(result))
        return rv
    }
    ...
    @inlinable func peekNth(n: Int) -> gpointer? {
        let result = g_queue_peek_nth(_ptr, guint(n))
        let rv = result
        return rv
    }

    /// Returns the link at the given position
    @inlinable func peekNthLink(n: Int) -> ListRef! {
        let result = g_queue_peek_nth_link(_ptr, guint(n))
        let rv = ListRef(gconstpointer: gconstpointer(result))
        return rv
    }
    ...
    @inlinable func peekTail() -> gpointer? {
        let result = g_queue_peek_tail(_ptr)
        let rv = result
        return rv
    }

    /// Returns the last link in `queue`.
    @inlinable func peekTailLink() -> ListRef! {
        let result = g_queue_peek_tail_link(_ptr)
        let rv = ListRef(gconstpointer: gconstpointer(result))
        return rv
    }
    ...
    @inlinable func popHead() -> gpointer? {
        let result = g_queue_pop_head(_ptr)
        let rv = result
        return rv
    }

    /// Removes and returns the first element of the queue.
    @inlinable func popHeadLink() -> ListRef! {
        let result = g_queue_pop_head_link(_ptr)
        let rv = ListRef(gconstpointer: gconstpointer(result))
        return rv
    }
    ...
    @inlinable func popNth(n: Int) -> gpointer? {
        let result = g_queue_pop_nth(_ptr, guint(n))
        let rv = result
        return rv
    }

    /// Removes and returns the link at the given position.
    @inlinable func popNthLink(n: Int) -> ListRef! {
        let result = g_queue_pop_nth_link(_ptr, guint(n))
        let rv = ListRef(gconstpointer: gconstpointer(result))
        return rv
    }
    ...
    @inlinable func popTail() -> gpointer? {
        let result = g_queue_pop_tail(_ptr)
        let rv = result
        return rv
    }

    /// Removes and returns the last element of the queue.
    @inlinable func popTailLink() -> ListRef! {
        let result = g_queue_pop_tail_link(_ptr)
        let rv = ListRef(gconstpointer: gconstpointer(result))
        return rv
    }
    ...
    @inlinable func remove(data: gconstpointer? = nil) -> Bool {
        let result = g_queue_remove(_ptr, data)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func removeAll(data: gconstpointer? = nil) -> Int {
        let result = g_queue_remove_all(_ptr, data)
        let rv = Int(result)
        return rv
    }
    ...
    @inlinable var isEmpty: Bool {
        /// Returns `true` if the queue is empty.
        get {
            let result = g_queue_is_empty(_ptr)
        let rv = ((result) != 0)
            return rv
        }
    }
