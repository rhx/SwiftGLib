...
open class StringType: StringTypeProtocol {
    ...
    /// i.e., ownership is transferred to the `StringType` instance.
    /// - Parameter op: pointer to the underlying object
    public init(retaining op: UnsafeMutablePointer<GString>) {
        ptr = UnsafeMutableRawPointer(op)
    ...
    /// - Parameter other: an instance of a related type that implements `StringTypeProtocol`
    public init<T: StringTypeProtocol>(_ other: T) {
        ptr = UnsafeMutableRawPointer(other.gstring_ptr)
        // no reference counting for GString, cannot ref(cast(gstring_ptr))
    }
...
// MARK: String Record: StringTypeProtocol extension (methods and fields)
public extension StringTypeProtocol {
    ...
    func append(val: UnsafePointer<gchar>) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_append(cast(gstring_ptr), val))
        return cast(rv)
    }
    ...
    func append(c: gchar) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_append_c(cast(gstring_ptr), c))
        return cast(rv)
    }
    ...
    func appendLen(val: UnsafePointer<gchar>, len: gssize) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_append_len(cast(gstring_ptr), val, len))
        return cast(rv)
    }
    ...
    func appendUnichar(wc: gunichar) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_append_unichar(cast(gstring_ptr), wc))
        return cast(rv)
    }
    ...
    func appendURIEscaped(unescaped: UnsafePointer<gchar>, reservedCharsAllowed reserved_chars_allowed: UnsafePointer<gchar>, allowUTF8 allow_utf8: Bool) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_append_uri_escaped(cast(gstring_ptr), unescaped, reserved_chars_allowed, gboolean(allow_utf8 ? 1 : 0)))
        return cast(rv)
    }
    ...
    func asciiDown() -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_ascii_down(cast(gstring_ptr)))
        return cast(rv)
    }

    /// Converts all lowercase ASCII letters to uppercase ASCII letters.
    func asciiUp() -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_ascii_up(cast(gstring_ptr)))
        return cast(rv)
    }
    ...
    func assign(rval: UnsafePointer<gchar>) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_assign(cast(gstring_ptr), rval))
        return cast(rv)
    }
    ...
    @available(*, deprecated) func down() -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_down(cast(gstring_ptr)))
        return cast(rv)
    }
    ...
    func erase(pos: gssize, len: gssize) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_erase(cast(gstring_ptr), pos, len))
        return cast(rv)
    }
    ...
    @discardableResult func free(freeSegment free_segment: Bool) -> UnsafeMutableRawPointer? {
        let rv: String! = cast(g_string_free(cast(gstring_ptr), gboolean(free_segment ? 1 : 0)))
        return cast(rv)
    }
    ...
    func freeToBytes() -> UnsafeMutablePointer<GBytes>! {
        let rv: UnsafeMutablePointer<GBytes>! = cast(g_string_free_to_bytes(cast(gstring_ptr)))
        return cast(rv)
    }

    /// Creates a hash code for `str`; for use with `GHashTable`.
    func hash() -> Int {
        let rv: Int = cast(g_string_hash(cast(gstring_ptr)))
        return Int(rv)
    }

    /// Inserts a copy of a string into a `GString`,
    /// expanding it if necessary.
    @discardableResult func insert(pos: gssize, val: UnsafePointer<gchar>) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_insert(cast(gstring_ptr), pos, val))
        return cast(rv)
    }

    /// Inserts a byte into a `GString`, expanding it if necessary.
    @discardableResult func insertC(pos: gssize, c: gchar) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_insert_c(cast(gstring_ptr), pos, c))
        return cast(rv)
    }
    ...
    @discardableResult func insertLen(pos: gssize, val: UnsafePointer<gchar>, len: gssize) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_insert_len(cast(gstring_ptr), pos, val, len))
        return cast(rv)
    }

    /// Converts a Unicode character into UTF-8, and insert it
    /// into the string at the given position.
    @discardableResult func insertUnichar(pos: gssize, wc: gunichar) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_insert_unichar(cast(gstring_ptr), pos, wc))
        return cast(rv)
    }

    /// Overwrites part of a string, lengthening it if necessary.
    func overwrite(pos: Int, val: UnsafePointer<gchar>) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_overwrite(cast(gstring_ptr), gsize(pos), val))
        return cast(rv)
    }
    ...
    func overwriteLen(pos: Int, val: UnsafePointer<gchar>, len: gssize) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_overwrite_len(cast(gstring_ptr), gsize(pos), val, len))
        return cast(rv)
    }

    /// Adds a string on to the start of a `GString`,
    /// expanding it if necessary.
    @discardableResult func prepend(val: UnsafePointer<gchar>) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_prepend(cast(gstring_ptr), val))
        return cast(rv)
    }

    /// Adds a byte onto the start of a `GString`,
    /// expanding it if necessary.
    @discardableResult func prepend(c: gchar) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_prepend_c(cast(gstring_ptr), c))
        return cast(rv)
    }
    ...
    @discardableResult func prependLen(val: UnsafePointer<gchar>, len: gssize) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_prepend_len(cast(gstring_ptr), val, len))
        return cast(rv)
    }

    /// Converts a Unicode character into UTF-8, and prepends it
    /// to the string.
    @discardableResult func prependUnichar(wc: gunichar) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_prepend_unichar(cast(gstring_ptr), wc))
        return cast(rv)
    }
    ...
    @discardableResult func setSize(len: Int) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_set_size(cast(gstring_ptr), gsize(len)))
        return cast(rv)
    }

    /// Cuts off the end of the GString, leaving the first `len` bytes.
    func truncate(len: Int) -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_truncate(cast(gstring_ptr), gsize(len)))
        return cast(rv)
    }
    ...
    @available(*, deprecated) func up() -> UnsafeMutablePointer<GString>! {
        let rv: UnsafeMutablePointer<GString>! = cast(g_string_up(cast(gstring_ptr)))
        return cast(rv)
    }
    ...
    var str: UnsafePointer<CChar> {
        ...
        ///   can be used as an ordinary C string.
        get {
            let rv: UnsafePointer<CChar> = cast(gstring_ptr.pointee.str)
            return rv
        }
        /// points to the character data. It may move as text is added.
        ///   The `str` field is null-terminated and so
        ///   can be used as an ordinary C string.
         set {
            gstring_ptr.pointee.str = cast(newValue)
        }
    }
    ...
    var len: Int {
        ...
        ///   terminating nul byte.
        get {
            let rv: Int = cast(gstring_ptr.pointee.len)
            return rv
        }
        /// contains the length of the string, not including the
        ///   terminating nul byte.
         set {
            gstring_ptr.pointee.len = gsize(newValue)
        }
    }
    ...
    var allocatedLen: Int {
        ...
        ///   string before it needs to be reallocated. May be larger than `len`.
        get {
            let rv: Int = cast(gstring_ptr.pointee.allocated_len)
            return rv
        }
        /// the number of bytes that can be stored in the
        ///   string before it needs to be reallocated. May be larger than `len`.
         set {
            gstring_ptr.pointee.allocated_len = gsize(newValue)
        }
    }
