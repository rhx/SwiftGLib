...
extension ByteArrayBase: RandomAccessCollection, MutableCollection {}
extension ByteArrayRef: RandomAccessCollection, MutableCollection {}

/// A byte array class represented by an underlying `GByteArray`.
///
/// This class extends `ByteArrayBase` and makes it conform to
/// `ExpressibleByArrayLiteral`.
 open class ByteArray: ByteArrayBase, ExpressibleByArrayLiteral {
