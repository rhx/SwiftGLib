...
public let HAVE_GNUC_VISIBILITY = G_HAVE_GNUC_VISIBILITY /* gint 1 */
...
public let KEY_FILE_DESKTOP_GROUP = G_KEY_FILE_DESKTOP_GROUP /* utf8 39 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a string list
/// giving the available application actions.
public let KEY_FILE_DESKTOP_KEY_ACTIONS = G_KEY_FILE_DESKTOP_KEY_ACTIONS /* utf8 40 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a list
/// of strings giving the categories in which the desktop entry
/// should be shown in a menu.
public let KEY_FILE_DESKTOP_KEY_CATEGORIES = G_KEY_FILE_DESKTOP_KEY_CATEGORIES /* utf8 41 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a localized
/// string giving the tooltip for the desktop entry.
public let KEY_FILE_DESKTOP_KEY_COMMENT = G_KEY_FILE_DESKTOP_KEY_COMMENT /* utf8 42 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a boolean set to true
/// if the application is D-Bus activatable.
public let KEY_FILE_DESKTOP_KEY_DBUS_ACTIVATABLE = G_KEY_FILE_DESKTOP_KEY_DBUS_ACTIVATABLE /* utf8 43 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a string
/// giving the command line to execute. It is only valid for desktop
/// entries with the `Application` type.
public let KEY_FILE_DESKTOP_KEY_EXEC = G_KEY_FILE_DESKTOP_KEY_EXEC /* utf8 44 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a localized
/// string giving the generic name of the desktop entry.
public let KEY_FILE_DESKTOP_KEY_GENERIC_NAME = G_KEY_FILE_DESKTOP_KEY_GENERIC_NAME /* utf8 45 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a boolean
/// stating whether the desktop entry has been deleted by the user.
public let KEY_FILE_DESKTOP_KEY_HIDDEN = G_KEY_FILE_DESKTOP_KEY_HIDDEN /* utf8 46 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a localized
/// string giving the name of the icon to be displayed for the desktop
/// entry.
public let KEY_FILE_DESKTOP_KEY_ICON = G_KEY_FILE_DESKTOP_KEY_ICON /* utf8 47 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a list
/// of strings giving the MIME types supported by this desktop entry.
public let KEY_FILE_DESKTOP_KEY_MIME_TYPE = G_KEY_FILE_DESKTOP_KEY_MIME_TYPE /* utf8 48 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a localized
/// string giving the specific name of the desktop entry.
public let KEY_FILE_DESKTOP_KEY_NAME = G_KEY_FILE_DESKTOP_KEY_NAME /* utf8 49 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a list of
/// strings identifying the environments that should not display the
/// desktop entry.
public let KEY_FILE_DESKTOP_KEY_NOT_SHOW_IN = G_KEY_FILE_DESKTOP_KEY_NOT_SHOW_IN /* utf8 50 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a boolean
/// stating whether the desktop entry should be shown in menus.
public let KEY_FILE_DESKTOP_KEY_NO_DISPLAY = G_KEY_FILE_DESKTOP_KEY_NO_DISPLAY /* utf8 51 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a list of
/// strings identifying the environments that should display the
/// desktop entry.
public let KEY_FILE_DESKTOP_KEY_ONLY_SHOW_IN = G_KEY_FILE_DESKTOP_KEY_ONLY_SHOW_IN /* utf8 52 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a string
/// containing the working directory to run the program in. It is only
/// valid for desktop entries with the `Application` type.
public let KEY_FILE_DESKTOP_KEY_PATH = G_KEY_FILE_DESKTOP_KEY_PATH /* utf8 53 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a boolean
/// stating whether the application supports the
/// [Startup Notification Protocol Specification](http://www.freedesktop.org/Standards/startup-notification-spec).
public let KEY_FILE_DESKTOP_KEY_STARTUP_NOTIFY = G_KEY_FILE_DESKTOP_KEY_STARTUP_NOTIFY /* utf8 54 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is string
/// identifying the WM class or name hint of a window that the application
/// will create, which can be used to emulate Startup Notification with
/// older applications.
public let KEY_FILE_DESKTOP_KEY_STARTUP_WM_CLASS = G_KEY_FILE_DESKTOP_KEY_STARTUP_WM_CLASS /* utf8 55 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a boolean
/// stating whether the program should be run in a terminal window.
/// It is only valid for desktop entries with the
/// `Application` type.
public let KEY_FILE_DESKTOP_KEY_TERMINAL = G_KEY_FILE_DESKTOP_KEY_TERMINAL /* utf8 56 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a string
/// giving the file name of a binary on disk used to determine if the
/// program is actually installed. It is only valid for desktop entries
/// with the `Application` type.
public let KEY_FILE_DESKTOP_KEY_TRY_EXEC = G_KEY_FILE_DESKTOP_KEY_TRY_EXEC /* utf8 57 */
...
public let KEY_FILE_DESKTOP_KEY_TYPE = G_KEY_FILE_DESKTOP_KEY_TYPE /* utf8 58 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a string
/// giving the URL to access. It is only valid for desktop entries
/// with the `Link` type.
public let KEY_FILE_DESKTOP_KEY_URL = G_KEY_FILE_DESKTOP_KEY_URL /* utf8 59 */

/// A key under `G_KEY_FILE_DESKTOP_GROUP`, whose value is a string
/// giving the version of the Desktop Entry Specification used for
/// the desktop entry file.
public let KEY_FILE_DESKTOP_KEY_VERSION = G_KEY_FILE_DESKTOP_KEY_VERSION /* utf8 60 */

/// The value of the `G_KEY_FILE_DESKTOP_KEY_TYPE`, key for desktop
/// entries representing applications.
public let KEY_FILE_DESKTOP_TYPE_APPLICATION = G_KEY_FILE_DESKTOP_TYPE_APPLICATION /* utf8 61 */

/// The value of the `G_KEY_FILE_DESKTOP_KEY_TYPE`, key for desktop
/// entries representing directories.
public let KEY_FILE_DESKTOP_TYPE_DIRECTORY = G_KEY_FILE_DESKTOP_TYPE_DIRECTORY /* utf8 62 */

/// The value of the `G_KEY_FILE_DESKTOP_KEY_TYPE`, key for desktop
/// entries representing links to documents.
public let KEY_FILE_DESKTOP_TYPE_LINK = G_KEY_FILE_DESKTOP_TYPE_LINK /* utf8 63 */
...
public let LN10 = G_LN10 /* gdouble 65 */

/// The natural logarithm of 2.
public let LN2 = G_LN2 /* gdouble 66 */

/// Multiplying the base 2 exponent by this number yields the base 10 exponent.
public let LOG_2_BASE_10 = G_LOG_2_BASE_10 /* gdouble 67 */
...
public let MAXUINT64: UInt64 = 78 /* G_MAXUINT64 */
...
/// application compile time, rather than from the library
/// linked against at application run time.
public let MICRO_VERSION = GLIB_MICRO_VERSION /* gint 3 */
...
/// application compile time, rather than from the library
/// linked against at application run time.
public let MINOR_VERSION = GLIB_MINOR_VERSION /* gint 64 */

public let MODULE_SUFFIX = G_MODULE_SUFFIX /* utf8 86 */
...
public let OPTION_REMAINING = G_OPTION_REMAINING /* utf8 87 */
...
public let PI = G_PI /* gdouble 89 */

/// A format specifier that can be used in `printf()`-style format strings
/// when printing a `GPid`.
public let PID_FORMAT = G_PID_FORMAT /* utf8 90 */

/// Pi divided by 2.
public let PI_2 = G_PI_2 /* gdouble 91 */

/// Pi divided by 4.
public let PI_4 = G_PI_4 /* gdouble 92 */

/// A format specifier that can be used in `printf()`-style format strings
/// when printing the `fd` member of a `GPollFD`.
public let POLLFD_FORMAT = G_POLLFD_FORMAT /* utf8 93 */
...
/// This is ":" on UNIX machines and ";" under Windows.
public let SEARCHPATH_SEPARATOR_S = G_SEARCHPATH_SEPARATOR_S /* utf8 100 */
...
public let SOURCE_CONTINUE = G_SOURCE_CONTINUE /* gboolean 105 */

/// Use this macro as the return value of a `GSourceFunc` to remove
/// the `GSource` from the main loop.
public let SOURCE_REMOVE = G_SOURCE_REMOVE /* gboolean 106 */

/// The square root of two.
public let SQRT2 = G_SQRT2 /* gdouble 107 */

/// The standard delimiters, used in `g_strdelimit()`.
public let STR_DELIMITERS = G_STR_DELIMITERS /* utf8 108 */
...
public let TEST_OPTION_ISOLATE_DIRS = G_TEST_OPTION_ISOLATE_DIRS /* utf8 115 */
...
public let URI_RESERVED_CHARS_GENERIC_DELIMITERS = G_URI_RESERVED_CHARS_GENERIC_DELIMITERS /* utf8 122 */

/// Subcomponent delimiter characters as defined in RFC 3986. Includes "!$&'()*+,;=".
public let URI_RESERVED_CHARS_SUBCOMPONENT_DELIMITERS = G_URI_RESERVED_CHARS_SUBCOMPONENT_DELIMITERS /* utf8 123 */
